    ...
    <section className="pt-4 pb-10 md:pt-8 md:pb-20">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start justify-items-center">
            {/* Venue Card */}
            <Card
              className={`overflow-hidden bg-card border-border transition-all duration-1000 max-w-2xl w-full ${
                isVisible ? "translate-x-0 opacity-100" : "-translate-x-full opacity-0"
              }`}
            >
              <div className="p-8 text-center">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start gap-3 justify-center">
                    ...
                    <p className="font-['Dancing_Script'] text-muted-foreground text-center">Tổ 5 Thôn Thái Đông, Xã Thăng Trường, Thành phố Đà Nẵng</p>
                  </div>
                ...
                <div className="p-6">
                  <div className="aspect-square rounded-lg overflow-hidden border-2 border-primary/20 shadow-lg">
                    <iframe
